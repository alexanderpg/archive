...
--
-- Структура таблицы `phpshop_bigcsv`
--

CREATE TABLE IF NOT EXISTS `phpshop_bigcsv` (
...
INSERT INTO `phpshop_bigcsv` (`id`, `file`, `status`, `seek`, `num_new`, `num_upd`, `aoption`, `num`) VALUES
('1', 'csv/sample_bigcsv.csv ', '0', 0, 0, 0, , 500);
...
(1, 'Москва', 0, '1', '1', 0, '', 0, 0, '1', '0', '', 0, '/UserFiles/Image/Payments/city.png'),
...
(7, 'Россия', 0, '1', '', 0, '', 0, 0, '1', '0', '', 1, '/UserFiles/Image/Payments/russia.png'),
...
CREATE TABLE IF NOT EXISTS `phpshop_shopusers` (
  ...
  `cumulative_discount` INT NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `phpshop_shopusers_status` (
  ...
  `enabled` enum('0','1') NOT NULL DEFAULT '1',
  `cumulative_discount_check` INT NOT NULL,
  `cumulative_discount` BLOB NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251;
...
CREATE TABLE IF NOT EXISTS `phpshop_sort_categories` (
  ...
  `page` varchar(255) NOT NULL DEFAULT '',
  `brand` enum('0','1') NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `category` (`category`)
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251;
...
(45, 'Торговая марка', 0, 48, '1', '', '', '', '', '1'),
(46, 'Цвет', 0, 48, '1', '', '1', '1', '', ''),
(48, 'Для каталога Одежда', 0, 0, '0', 'Группа характеристик служит для исключения дубликатов хар-к для различных категорий. Мы просто создаем Группу характеристик, и добавляем туда Цвет, вместо того, чтобы создавать Цвет для каждой категории. ', '', '0', '0', ''),
(49, 'Тип вашей кожи', 0, 50, '1', '', '', '', '', ''),
(50, 'Для каталога Косметика', 0, 0, '0', 'Группа характеристик служит для исключения дубликатов хар-к для различных категорий. Пример: мы просто создаем Группу характеристик, и добавляем туда Цвет, вместо того, чтобы создавать Цвет для каждой категории. ', '', '0', '0', ''),
(51, 'Косметический бренд', 0, 50, '1', '', '', '', '', '1'),
(52, 'Аромат', 0, 50, '1', '', '', '', '', ''),
(53, 'Производитель фототехники', 0, 54, '', '', '', '', '', '1'),
...
--
-- Структура таблицы `phpshop_upload_backup`
--

CREATE TABLE IF NOT EXISTS `phpshop_upload_backup` (
...
--
-- Структура таблицы `phpshop_upload_list`
--

CREATE TABLE IF NOT EXISTS `phpshop_upload_list` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
(4, 'Гривны', 'гр.', 'UAU', '0.06', 4, '1'),
(5, 'Доллары', '$', 'USD', '0.03', 0, '1'),
...
--
-- Дамп данных таблицы `phpshop_citylist_city`
--
...
--
-- Дамп данных таблицы `phpshop_citylist_country`
--
...
--
-- Дамп данных таблицы `phpshop_citylist_region`
--
