...
(4, 'Баннер в меню', '<p>Этот баннер можно скрыть. Вставьте свой текст и картинку в меню Маркетинг - Баннеры, тип вывода "В меню каталога".</p>', '3', '0', '1', '', '0', '', '', '', '', '/UserFiles/Image/trial/popup740x410.jpg', 'Далее', '', '0');
