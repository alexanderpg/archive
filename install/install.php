...
" . $SysValue['license']['product_name'];
        ...
        if ($fp) {
            ...
            if (!empty($_POST['pas_send'])) {
                $CsvContent = str_replace("admin@localhost", $_POST['mail'], $CsvContent);
            }
            fclose($fp);
        }
...
Пароль: <strong>" . $_POST['password'] . "</strong><br><br>
    ...
    &nbsp;&nbsp;<label><input type="checkbox" name="selectLic">Я принимаю условия лицензионного соглашения</label>
    </DIV>
    <br>
    <hr>
