...
(4, 'Visa, Mastercard, Yandex (Robokassa)', 'robox', '1', 1, '<img src="/UserFiles/Image/Trial/rabbit.png" alt="" align="" border="0"><h3>Благодарим Вас за заказ!</h3><p>Ваш заказ оплачен, в ближайшее время наш менеджер свяжется с Вами.</p>', '', '', '/UserFiles/Image/Payments/robox.png');
