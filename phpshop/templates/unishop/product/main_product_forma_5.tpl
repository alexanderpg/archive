...
@ComEndNotice@
            ...
            <div class="product-block-button">
                <button class="btn btn-wishlist addToCompareList hidden-md" data-uid="@productUid@" data-title="{—равнить}" data-placement="top" data-toggle="tooltip"><i class="fa fa-bar-chart-o"></i></button>
                <button class="btn btn-wishlist addToWishList" data-uid="@productUid@" data-title="{ќтложить}" data-placement="top" data-toggle="tooltip"><i class="feather iconz-heart"></i></button>
