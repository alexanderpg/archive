                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-10 ">
                                ...
                                <div class="shop-filter-tab">
                                    <ul class="nav nav-pillsnav-segment" role="tablist" style="align-items:center;">
                                        ...
                                        <li>
                                            <select name="s" id="filter-well-select" class="form-control" size="1">
                                ...
                                <div class="shop-filter-tab">
                                    <ul class="nav nav-pillsnav-segment float-right" id="filter-well" role="tablist" style="align-items:center;">
                                        ...
                                        <li class="nav-item list-inline-item d-none d-md-block">
                                            <a class="nav-link filter-item @gridSetAactive@" name="gridChange" value="1" data-toggle="tooltip" href="#" data-placement="top" data-original-title="Список"><i class="fal fa-list "></i></a>
                                        </li>
                                        <li class="nav-item d-none d-md-block" >
                                            <a class="nav-link filter-item @gridSetBactive@" name="gridChange" value="2" data-toggle="tooltip" href="#" data-placement="top" data-original-title="Ячейки"><i class="fal fa-border-none"></i></a>
                                        </li>
                                        <li class="nav-item d-block d-md-none @php __hide('vendorCatDisp','parser','d-block d-md-none'); php@">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a href="?" id="faset-filter-reset" class="">{Сбросить}</a>
                            <a href="#" class="" data-dismiss="modal">{Применить}</a>
                        </div>
                    </div>
                </div>
            </div>
