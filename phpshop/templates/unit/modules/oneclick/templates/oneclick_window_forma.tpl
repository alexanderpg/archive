<div class="modal fade bs-example-modal-sm oneclick-modal" id="oneClickModal@productUid@" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" method="post" name="ajax-form" action="@ShopDir@/oneclick/" data-modal="oneClickModal@productUid@">
...
<a href="#" data-toggle="modal" data-target="#oneClickModal@productUid@" class="btn btn-default click-btn"> {Купить в 1 клик}</a>
<script>$(document).ready($('#oneClickModal@productUid@').appendTo($('body')));</script>