...
<div class="col-md-4">
    <div class="thumbnail">
        <a class="highslide" onclick="return hs.expand(this);" href="@productImgBigFoto@" target="_blank" getParams="null" title="@productName@"><img data-src="@productImg@" alt="@productName@"></a>
        <div class="caption">
