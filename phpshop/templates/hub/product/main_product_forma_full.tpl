...
<div class="product-page-main-block row product-number-fix" itemscope itemtype="http://schema.org/Product">
    ...
    <div class="col-xs-12 col-md-7">
        <div class="col-xs-12">
            <div class="row">
                <h1 class="product-name page-title hide" itemprop="name">@productName@</h1>
            </div>
        </div>
        <div class="col-xs-12">
            <div class="row">
