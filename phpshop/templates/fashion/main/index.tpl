...
<html lang="@lang@">
    <head>
        ...
        <!-- Bootstrap -->
        <link id="bootstrap_theme" data-name="@php echo $_SESSION['skin']; php@" href="@pathTemplate@css/@fashion_theme@.css" rel="stylesheet">
    </head>
    <body id="body" data-dir="@ShopDir@" data-path="@php echo $GLOBALS['PHPShopNav']->objNav['path']; php@" data-id="@php echo $GLOBALS['PHPShopNav']->objNav['id']; php@" data-subpath="@php echo $GLOBALS['PHPShopNav']->objNav['name']; php@" data-token="@dadataToken@">
        ...
        <!-- ========== HEADER ========== -->
        <header id="header" class="header center-aligned-navbar">
            ...
            <div class="header-section">
                ...
                <!-- End Topbar -->
                <!-- Logo -->
                <a class="navbar-brand @php __hide('logo'); php@ d-block mx-auto" href="/" aria-label="" title="{Домой}">
                    <img src="@logo@" class="logo" alt="">
                </a>
                <!-- End Logo -->
                <div id="logoAndNav" class="w-xl-60 w-lg-80 text-center mx-auto px-2">
                    <!-- Nav -->
       ...
       "draggable": false
            ...
            <!-- Categories Section -->
            <div class="container space-2 space-lg-2 @php __hide('leftCatalTable'); php@">
                    ...
                    <div class="col-lg-3 mb-5">
                        <div class="d-flex align-items-start flex-column">
                            <a class="w-100 mb-3 mb-lg-auto" href="/" title="@name@">
                                <img class="brand mb-3" src="@logo@" alt="@name@">
                            </a>
                            <ul class="nav nav-sm nav-x-0 flex-column" itemscope itemtype="http://schema.org/Organization">
                                ...
                                <li class="nav-item text-muted">@sticker_footer_icon@</li>
                            </ul>
                        </div>
                    </div>
