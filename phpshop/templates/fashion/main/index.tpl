...
<html lang="@lang@">
    ...
    <body id="body" data-dir="@ShopDir@" data-path="@php echo $GLOBALS['PHPShopNav']->objNav['path']; php@" data-id="@php echo $GLOBALS['PHPShopNav']->objNav['id']; php@" data-subpath="@php echo $GLOBALS['PHPShopNav']->objNav['name']; php@" data-token="@dadataToken@">
        ...
        <main id="content" role="main">
            ...
            <div class="container space-1 space-top-md-0 @hideSite@">
            ...
            <!-- Promo Section -->
            <div class="bg-soft-indigo text-indigo @php __hide('productDay'); php@ @hideSite@">
                @productDay@
            </div>
            <!-- End Promo Section -->
            ...
            <div class="container space-2 space-lg-2 border-top @hideSite@">
                <!-- Nav -->
