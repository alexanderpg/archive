...
<form method="post" name="forma_order" id="forma_order" action="/done/">
    ...
    <div class="panel panel-default no-margin">
        ...
        <div class="panel-body">
            @authData@ @noAuth@                  
<label><input type="checkbox" value="on" name="rule" class="req" required="">  {Я согласен} <a href="/page/soglasie_na_obrabotku_personalnyh_dannyh.html">{на обработку моих персональных данных}</a></label>
