...
<div itemscope itemtype="http://schema.org/Product" class="main-product-block product-1">
            ...
            <div class="product-info-block">
                ...
                <div class="flex-block">
                    ...
                    <div class="product-block-btn">
                        ...
                        <button class="btn btn-circle addToCompareList" role="button" data-uid="@productUid@">
                            <span class="icons-compare"></span>
                        </button>
                        <button class="btn btn-circle addToWishList" role="button" data-uid="@productUid@">
                ...
                <div class="input-group addToCart">
                    ...
                    <button class="btn btn-primary addToCartFull @legoPurchaseDisabled@" data-num="1" data-uid="@productUid@">
                        @productSale@
                    </button>
                    @ComStartNotice@
