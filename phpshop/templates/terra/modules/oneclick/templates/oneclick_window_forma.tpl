...
<a href="#" data-toggle="modal" data-target="#oneClickModal@productUid@" class="btn btn-cart btn-oneclick"><i class="fa fa-history" aria-hidden="true"></i> {Купить в 1 клик}</a>