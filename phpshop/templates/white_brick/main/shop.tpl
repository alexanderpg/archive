...
<html>
        ...
        <header id="header">
            <div class="container">
                ...
                <nav id="menu" class="row hidden-phone">
                    ...
                    @topBrands@
                    <div class="sep-menu-link"><img src="images/separator.gif" width="1" height="20" alt=""></div>
            ...
            <div id="notification">
                <div class="success-notification" style="display: none;"> <span class="notification-alert"> </span> <img src="images/close.png" alt="" class="close"> </div>
            </div>
        </header>
        <section id="midsection" class="container">
            <div class="row"> @php if($_SESSION['UsersId'] AND $GLOBALS['SysValue']['nav']['path'] == "users") echo '
                <aside class="span3" id="column-left" >
                    <div class="hidden-phone @UidLeftColHide@_hide" id="lrc">
                        <div class="box">
                ...
                ';  php@
                <div class="hidden-phone @UidLeftColHide@_hide" id="lrc@UidLeftColHide@" @php if($_SESSION['UsersId'] AND $GLOBALS['SysValue']['nav']['path'] == "users") echo ' style="display:none;"'; php@>
                     <aside class="span3" id="column-left" > @skinSelect@
                        <div class="box">
                            <div class="box-heading">
                                <h2>Категории</h2>
                            </div>
            ...
            opendcAccordion('@thisCat2@');
                ...
                <section class="span9 @UidLeftColHide@" id="content">
                    <div class="row-fluid"> 
    ...
    <script type="text/javascript" src="@php echo $GLOBALS['SysValue']['dir']['templates'].chr(47).$_SESSION['skin'].chr(47); php@js/bootstrap.min.js"></script>
