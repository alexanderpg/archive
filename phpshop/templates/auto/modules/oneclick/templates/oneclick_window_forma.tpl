<div class="modal fade bs-example-modal-sm oneclick-modal" id="oneClickModal@productUid@" tabindex="-1" role="dialog"  aria-hidden="true">
    ...
    <div class="mb-4">
	      <div class="mb-4">
            <button data-toggle="modal" data-target="#oneClickModal@productUid@"  type="button" class="btn btn-block btn-soft-primary transition-3d-hover">{Купить в 1 клик}</button><script>$(document).ready($('#oneClickModal@productUid@').appendTo($('body')));</script>
    </div>
