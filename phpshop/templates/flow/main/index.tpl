...
<html lang="@lang@">
    <head>
        ...
        <link rel="preload" href="//fonts.googleapis.com/css2?family=Open+Sans:wght@400;600&display=swap" as="style">
        ...
        <!-- Bootstrap -->
        <link id="bootstrap_theme" data-name="@php echo $_SESSION['skin']; php@" href="@pathTemplate@css/@flow_theme@.css" rel="stylesheet">
    </head>
        ...
        <main id="content" role="main">
            ...
            <div class="container space-2 space-lg-2 @php __hide('specMain'); php@ @hideSite@">
                ...
                <div class="text-center">
                    <a class="btn btn-primary btn-pill transition-3d-hover px-5" href="/spec/">{Посмотреть все товары}</a>
                </div>
            </div>
