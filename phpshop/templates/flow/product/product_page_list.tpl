...
<div class="container space-top-0 space-top-md-0 space-bottom-1 space-bottom-lg-1">
    ...
    <div class="@php __hide('empty_product_list','isset'); php@">
        <div class="d-none d-sm-block">@vendorCatDisp@</div>
    </div>
    <!--/ Виртуальный каталог -->
                ...
                <div class="mr-2 col-lg-12">
                    ...
                    <ul class="nav nav-segment float-right" id="filter-well">
                        <li class="list-inline-item d-none d-sm-block">
                            <a class="nav-link filter-item @gridSetAactive@" href="#" data-toggle="tooltip" data-placement="top" title="{Товары сеткой}" name="gridChange" value="1">
                                <i class="fas fa-list"></i>
                            </a>
                        </li>
                        <li class="list-inline-item d-none d-sm-block">
                            <a class="nav-link filter-item @gridSetBactive@" href="#" data-toggle="tooltip" data-placement="top" title="{Товары списком}" name="gridChange" value="2">
                                <i class="fas fa-th-large"></i>
                            </a>
                        </li>
                        <li class="list-inline-item d-block d-sm-none @php __hide('vendorCatDisp','parser','d-block d-sm-none'); php@">
