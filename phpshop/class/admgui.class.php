    ...
    function setCaption() {
        ...
        foreach ($Arg as $key => $val) {
            ...
            if ($key == 0 && $this->checkbox_action) {
                ...
                // размер
                if(!empty($val[1]) and !$this->mobile)
                   $width = 'width="' . $val[1] . '"';
            ...
            if ($key == 0 && $this->checkbox_action) {
                ...
                if (is_array($val)) {
                    ...
                    if (isset($val['link'])) {
                        ...
                        $row = '<a href="' . $val['link'] . '" ' . $popover . ' ' . $modal . ' class="' . $val['class'] . '" target="' . $val['target'] . '" title="' . $val['title'] . '">' . $val['name'] . '</a>' . $val['addon'];
                    } else
                        $row = $val['name'];
