...
function addSeoBrandURL($data) {
    ...
    if($vendorCategory["brand"] == 1){
        ...
        $PHPShopGUI->_CODE.=$PHPShopGUI->setField("Ссылка:", $PHPShopGUI->setInput("text", "sort_seo_name_value", $data['sort_seo_name'], "left", false,false,"form-control",false,'/brand/', '.html'), 1);
    }
