...
function actionStart() {
    ...
    $registerLink = null;
    if(empty($data['api'])) {
        $registerLink = '<a href="https://cloudsearch.dev/register" target="_blank">' . __('Регистрация') . '</a>';
    }
    ...
    <ol>
        <li><a href="https://cloudsearch.dev/register" target="_blank">Зарегистрировать аккаунт</a> 
        ...
        <li>В <a href="https://cloudsearch.dev/personal" target="_blank">Личном кабинете</a> открыть "Параметры интеграции" и скопировать <kbd>API идентификатор</kbd> в поле <kbd>API идентификатор</kbd> настроек модуля. Нажать кнопку "Сохранить".</li>
