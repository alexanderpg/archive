...
function actionStart() {
    ...
    $Tab3 = $PHPShopGUI->setPay($data['serial'], false, $data['version'], true);
            ...
            $info='Для работы модуля требуется настроить форму HTTP-уведомления по ссылке: <a href="https://sp-money.yandex.ru/myservices/online.xml" target="_blank">https://sp-money.yandex.ru/myservices/online.xml</a>. В качестве адреса для уведомлений нужно указать <code>http://'.$_SERVER['SERVER_NAME'].'/phpshop/modules/yandexmoney/payment/result.php</code>. 
                <p>
