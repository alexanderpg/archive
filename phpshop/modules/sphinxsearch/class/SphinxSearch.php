...
/**
 * Ѕиблиотека работы с поиском Sphinx
...
class SphinxSearch {
    ...
    public function setPaginator($page, $total, $pageSize, $obj, $query, $category, $pole) {
        ...
        if ($pageCount > 1) {
            ...
            // Ќазначаем переменную шаблонизатора
    ...
    public function searchAjax($query, $obj, $limit = 5) {
        ...
        // ”бираем дублирование в другой раскладке
    ...
    public static function getWordForm($num, $form_for_1, $form_for_2, $form_for_5) {
        ...
        $num_x = $num % 10; // сбрасываем дес€тки и записываем в новую переменную
        if ($num > 10 && $num < 20) // если число принадлежит отрезку [11;19]
            return $form_for_5;
        if ($num_x > 1 && $num_x < 5) // иначе если число оканчиваетс€ на 2,3,4
            return $form_for_2;
        if ($num_x == 1) // иначе если оканчиваетс€ на 1
            return $form_for_1;
