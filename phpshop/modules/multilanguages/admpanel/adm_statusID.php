...
function addStatusMultilanguages($data) {
...
function updateStatusMultilanguages($data) {
...
$addHandler=array(
        'actionStart'=>'addStatusMultilanguages',
        'actionDelete'=>false,
        'actionUpdate'=>'updateStatusMultilanguages'
);
