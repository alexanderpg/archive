...
function addCatalogMultilanguages($data) {
    ...
    $PHPShopGUI->addTab(array("Языки", $Tab3, true));
}

function updateCatalogMultilanguages($data) {
...
$addHandler = array(
    'actionStart' => 'addCatalogMultilanguages',
    'actionDelete' => false,
    'actionUpdate' => 'updateCatalogMultilanguages'
);
?>