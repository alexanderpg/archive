...
function tab_info($data) {
    ...
    <ol>
      <li>Настроить <a href="https://seller.ozon.ru/app/products/import/products-feed-update" target="_blank">обновление данных</a> о товарах через фид. Добавить в качестве ссылки на фид адрес <code>' .$OzonSeller->ssl. $_SERVER['SERVER_NAME'] . '/yml/?marketplace=ozon</code></li>
