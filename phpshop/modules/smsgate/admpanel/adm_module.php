...
function actionUpdate() {
    ...
    header('Location: ?path=modules&id=smsgate');
    return $action;
}
...
function actionStart() {
    ...
    $Tab1 =$PHPShopGUI->setText("Сервер API (по умолчанию phpshop4.incore1.ru): ", false)
    ...
    $Tab1.=$PHPShopGUI->setText("Имя отправителя (по умолчанию INCORE). Для использования в смс уникального имени отправителя необходимо согласование с вашим менеджером.:", false)
    ...
    $Info = '<div>
        <div class="panel panel-default">
          ...
          <div class="panel-body">
              ...
              <p>Стоимость смс с именем отправителя тарифицируется - 1,7 руб. Стоимость смс без имени отправителя - 1 руб.</p>
        ...
        <div class="well"><b>Стоимость Viber-сообщения с именем отправителя - 1 руб.<br>Стоимость смс  с именем отправителя - 1,7 руб.</b></div>
      </div>
    ';
    ...
    $TabCascade = $PHPShopGUI->setText("Сервер API каскадного режима (по умолчанию phpshop5.incore1.ru):", false)
        .$PHPShopGUI->setInput('text','cascade_domen_api_new',$cascade_domen_api,false,'','');

    $TabCascade .= $PHPShopGUI->setText("Имя отправителя (по умолчанию Com-info). Для использования уникального имени отправителя необходимо согласование с вашим менеджером.:", false)
    ...
    $TabCascadeInfo = $PHPShopGUI->setPanel('<b>Описание</b>', '
        ...
        <p>Объем Viber-сообщения до 1000 символов.<br>Есть возможность использования картинок и кнопки активности.</p>
        <br>
        <p>Стоимость Viber-сообщения с именем отправителя - 1 руб.<br>Стоимость смс  с именем отправителя - 1,7 руб.</p>
    ');
    ...
    $PHPShopGUI->setTab(
        ...
        array("Шаблоны сообщений", '<div class="smsgate">' . $tabTemplateMessage . '</div>', true),
        //array("Шаблоны для администратора", '<div class="smsgate">' . $Tab6 . '</div>', true),
        //array("Шаблоны для заказчика", '<div class="smsgate">' . $Tab2 . '</div>', true),
