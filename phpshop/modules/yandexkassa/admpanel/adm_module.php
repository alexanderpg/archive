...
<h4>Технические данные необходимые для регистрации и подключения к Яндекс.Касса</h4>
            <p>В личном кабинете Яндекс.Касса открыть Настройки/Магазин, "URL для уведомлений" указать<code>' . $protocol . $_SERVER['SERVER_NAME'] . '/phpshop/modules/yandexkassa/payment/check.php</code> <br>
                <p>Поле "<b>Секретный ключ</b>" необходимо скопировать с личного кабинета Яндекс.Кассы (Настройки/Ключи API, Секретный ключ).</p>
                <p>Поле "<b>ShopID</b>" необходимо скопировать с личного кабинета Яндекс.Кассы (Настройки/Магазин, shopId).</p>
