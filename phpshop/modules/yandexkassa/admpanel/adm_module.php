...
<h4>Технические данные необходимые для регистрации и подключения к ЮKassa</h4>
            <p>В личном кабинете ЮKassa открыть Настройки/Магазин, "URL для уведомлений" указать<code>' . $protocol . $_SERVER['SERVER_NAME'] . '/phpshop/modules/yandexkassa/payment/check.php</code> <br>
