...
function tab_info($data) {
    ...
    $Info = '<p>
     <h4>Настройка модуля</h4>
        ...
        <li>Указать адрес и порт сервера кеширования Memcached, по умолчанию <code>127.0.0.1</code> и <code>11211</code>.</li>
   ...
   <h4>Подключение Memcached на хостинге Beget</h4>
    ...
    <ol>
        <li>Для отображения в подробной карточке товара виджета расчета стоимости доставок используется переменная <code>@deliverywidget@</code> в файле шаблона <code>phpshop/templates/имя_шабдлона/product/main_product_forma_full.tpl</code></li>
    </ol>  
