<table border=0 width=99% cellpadding=0 cellspacing=3>
    <tr>
        ...
        <td width="5%" align="center"  class="mobHideCol"><strong>Операции</strong></td>
        <td width="14%" align="right"><strong>Цена 1 шт.</strong></td>
        <td width="14%" align="right"><strong>Стоимость</strong></td>
        <td width="12%" align="right"><strong>К начислению</strong></td>
        <td align="right">&nbsp;</td>
    </tr>
    <tr>
        <td  class="mobHideCol">
    ...
    <tr class="points-itog-order">
        <td colspan="2">
            К оплате с учетом списанных баллов (без учета доставки):
        </td>
        <td width="55" ></td>
        <td class="mobHideCol" width="30"></td>
        <td align="right" class="red" class="mobHideCol"></td>
        <td align="right" class="red"><b><span id="TotalSummaPoint">0</span></b></td>
        <td align="right" class="red"></td>
