...
<table width=99% cellpadding=2 cellspacing=0 align=center>
    <tr class=tablerow>
        ...
        <td class=tablerow>Стоимость (<?= $PHPShopOrder->default_valuta_code; ?>)</td>
        <td class=tablerow>Со скидкой (<?= $PHPShopOrder->default_valuta_code; ?>)</td>
    ...
    ?>
    <tr>
        <td colspan=7 align=right style="border-top: 1px solid #000000;border-left: 1px solid #000000;border-right: 1px solid #000000;">Скидка: общая</td>
    </tr>
    <tr>
        <td colspan=7 align=right style="border-top: 1px solid #000000;border-left: 1px solid #000000;border-right: 1px solid #000000;">Итого:
<?= $my_total ?>
<? if ($LoadItems['System']['nds_enabled']) { ?> 
                в т.ч. НДС:  <?= $my_nds ?>
<? } ?>
