...
function addMarketplacesTab($data) {
    ...
    $Tab .= $PHPShopGUI->setField('<a href="/yml/?marketplace=' . Marketplaces::SBERMARKET . '" target="_blank" title="Открыть файл">СберМаркет</a>', $PHPShopGUI->setCheckbox('sbermarket_new', 1, 'Вывод в СберМаркет', $data['sbermarket']));
    ...
    $Tab .= $PHPShopGUI->setField('Цена СберМаркет', $PHPShopGUI->setInputText(null, 'price_sbermarket_new', $data['price_sbermarket'], 150, $valuta_def_name), 2);
