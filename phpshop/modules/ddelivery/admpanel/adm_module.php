...
function actionStart() {
    ...
    $PHPShopGUI->setTab(array("Основные", $Tab1, true), array("Дополнительные", $Tab5, true), array("Настройки способов доставки", $Tab2, true), array("Настройки цены доставки", $Tab3,true), array("Описание", $Tab7, true), array("О Модуле", $Tab8, true) /* , array("Добавление собственных служб доставки",$Tab4,320) */);
