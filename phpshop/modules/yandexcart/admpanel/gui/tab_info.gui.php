...
function tab_info($data) {
    ...
    $Info = '<p>
      ...
      <h4>Настройка товара</h4>
        <ol>
        <li>В карточке редактирования товара в закладке <kbd>Яндекс</kbd> настроить дополнительные параметры вывода для Яндекс.Маркета.</li>
      ...
      <h4>Настройка доставки по моделей ADV и DBS</h4>
        <ol>
        <li>В карточке редактирования доставки в закладке <kbd>Яндекс</kbd> настроить дополнительные параметры вывода для Яндекс.Маркета.
      ...
      <h4>Настройка характеристики</h4>
        <ol>
        <li>В карточке редактирования характеристики в закладке <kbd>Яндекс</kbd> настроить дополнительные параметры вывода для Яндекс.Маркета.
