...
function tab_info($data) {
    ...
    $Info = '<p>
      <h4>Настройки параметров размещения в Яндекс.Маркет по модели ADV</h4>
        ...
        <li>Для выгрузки в СДЭК.Маркет упрощенного YML файла указать адрес: <code>http://' . $_SERVER['SERVER_NAME'] .$GLOBALS['SysValue']['dir']['dir']. '/yml/?cdek</code>
         <li>Для выгрузки в AliExpress YML файла указать адрес: <code>http://' . $_SERVER['SERVER_NAME'] .$GLOBALS['SysValue']['dir']['dir']. '/yml/?aliexpress</code>
        <li>Для выгрузки в RetailCRM YML файла указать адрес: <code>http://' . $_SERVER['SERVER_NAME'] .$GLOBALS['SysValue']['dir']['dir']. '/yml/?retailcrm</code>
        </ol>
