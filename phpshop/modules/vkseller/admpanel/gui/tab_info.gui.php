    ...
    $Info = '<p>
      ...
      <h4>Настройки параметров работы по модели API</h4>
        ...
        <h5>Настройка модуля</h5>      
         ...
         <li>Для получения <b>API Ключа</b> все поля должны быть заполнены и сохранены в настройках модуля. Перейдите по ссылке <kbd>Получить Персональный ключ</kbd>, полученные данные сохраните в поля <kbd>API key</kbd>,<kbd>Токен обновления</kbd> и <kbd>ID устройства</kbd>.</li>
      </ol>  
