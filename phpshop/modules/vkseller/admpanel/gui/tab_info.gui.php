...
function tab_info($data) {
    ...
    $Info = '<p>
      ...
      <h4>Настройки параметров работы по модели API</h4>
        ...
        <h5>Настройка модуля</h5>      
         ...
         <li>Выбрать статус заказов, поступающих с ВКонтакте.</li>
   ...
   <ol>
    ...
    <li>В карточке редактирования товара в магазине через закладку "Модули - ВКонтакте" включить опцию <kbd>Включить экспорт в VK</kbd> и сохранить данные. Список товаров для выгрузки в ВКонтакте доступен в разделе <kbd>Модули</kbd> &rarr; <b>VK Товары</b> &rarr; <b>Товары для VK</b>.</li>
