                        ...
                        <tbody>
                            ...
                            <tr>
                                <td bgcolor="#f3f3f3" align="center" height="60"
                                    style="font-size: 20px; color: #464646; font-weight: 700; background: #f3f3f3; border-radius:4px;font-family:    Helvetica, sans-serif; letter-spacing: 4px; ">{Требуется ручная активация пользователя} @user_name@
	                            </td>
                            </tr>
                            ...
                            <tr>
                                <td
									...
									<p>Email: @user_login@</p>
									<p>{Для активации, зайдите в меню Пользователи - Обзор пользователей, и в карточке пользователя переключите Статус на "Вкл.", и "Уведомить", если хотите отправить пользователю письмо-уведомление об активации}. <a target="_blank" href="http://@serverName@/phpshop/admpanel/">{Активировать}</a>.</p>
									<p>{Дата}: @date@<br>
									IP: @user_ip@</p>
                                </td>
                            </tr>
