...
<p>@user_name@, {Ваш личный кабинет успешно активирован администратором}. {Ваш логин} <b>@login@</b>, {пароль} <b>@password@</b>.</p>

<hr>
<p>{Вы можете задать нам вопрос в личном кабинете в разделе} <a href="http://@serverPath@users/message.html">{Связь с менеджером}</a>.</p>        
                                             </td>
                            </tr>
                        </tbody>
                    </table>
