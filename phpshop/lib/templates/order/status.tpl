...
<tbody>
    ...
    <tr bgcolor="#eaeaea">
        <td>
            ...
            <hr>
                <p>            
{Вы можете проверить статус заказа, загрузить файлы, распечатать платежные документы, через}  <a href="http://@serverPath@users/order.html?order_info=@ouid@#Order">{Личный кабинет}</a>
</p>
