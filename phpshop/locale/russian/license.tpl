    ...
    <p><b>3. 	Условия использования продукта и ограничения </b>
        <BR>3.1.	Пользователь имеет право бесплатно воспользоваться демо-версией Продукта, скачав с сайта Лицензиара www.phpshop.ru и установив на сервер в течение 30 дней, и без ограничений времени при установке на локальном компьютере. Демо-версии всех версий Продукта PHPShop работают без каких-либо ограничений функциональности, кроме ограничений в обработчике 1С версии PHPShop Pro.
...
<br> 5.1. Приобретая Интернет-магазина PHPShop Enterprise или PHPShop Pro, Пользователь получает бесплатную базовую техническую поддержку в течение 6 месяцев. Для версий PHPShop Basic срок поддержки составляет 3 месяца. 
    ...
    <p>
        ...
        Учебник: <a href="https://docs.phpshop.ru" target="_blank">docs.phpshop.ru</a> <br>
