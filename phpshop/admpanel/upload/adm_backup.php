...
$sql = "SELECT  backup_use FROM " . $SysValue['base']['table_name47'] . " WHERE date = (SELECT MAX(date) FROM " . $SysValue['base']['table_name47'] . ")";
...
<html>
    <head>
        <title>Автоматическое восстановление.</title>
    ...
    <body bottommargin="0"  topmargin="0" leftmargin="0" rightmargin="0">
        <form name="product_edit"  method=post onsubmit="return false;">
            <table cellpadding="0" cellspacing="0" width="100%" height="50" id="title">
                <tr bgcolor="#ffffff">
                    <td style="padding:10">
                        <b><span name=txtLang id=txtLang>Автоматическое восстановление файлов</span></b><br>
                ...
                <tr>
                    <td>
                        <div style="display:<?php echo $display1 ?>">
                            <span name=txtLang id=txtLang>Отчёт восставновления:</span><br><br>
                            <div id="upload_log" name="upload_log" style="display:block; width:350px; height:200px;background-color:#ffffff; border:1px solid #CCC; overflow:auto;"></div><br>
                    ...
                    <td valign="top">
                        ...
                        <strong>ШАГ 1.</strong> Внимение! Все изменения в базе данных после обновления будут утрачены.<br>
                        Начать восстановление системы до предыдущей версии до обновления?<br>
                        <button id=upload_button name=upload_button style="width:120px;margin:5px; " onclick="javascript:upload_go(12);
        return false;"><span name=txtLang id=txtLang>Выполнить</span></button><br>

                        <div id=dirList style="display:none;" >
                            <strong>ШАГ 2.</strong> Копирование файлов.<br>
                            <button id=upload_button1 name=upload_button1 style="width:120px; margin:5px; " onclick="javascript:upload_go(13);
        return false;"><span name=txtLang id=txtLang>Выполнить</span></button>
                            <br>
                            <br>
                        </div>

                        <div id=dirList_base style="display:none;" >
                            <strong>ШАГ 3.</strong> Обновить базу данных<br>
                            <button id=upload_button2 name=upload_button2 style="width:120px; margin:5px; " onclick="miniWin('../dumper/dumper.php?upload_action=upload_backup_back', 500, 430);
        $('dirList').style.display = 'inline';
        $('upload_button2').style.display = 'none';
        return false;"><span name=txtLang id=txtLang>Выполнить</span></button>
                            <br>
                            <br>
                        </div>
                        </div>
                        <div style="display:<?php echo $display2 ?>">Восстановление не возможно!!!</div>
