				...
				<tbody>
					<tr>
						...
						<table align="center" border="0" cellpadding="0" cellspacing="0" class="row" style="width:100%;max-width:100%;" width="100%">
							<tbody>
								<tr>
									<td align="center"  bgcolor="#FFFFFF" class="heroBg2"  style="background-image: url(&quot;https://www.phpshop.ru/images/layout3.png&quot;); background-position: center center; background-size: cover;" valign="top">
									<table align="center" border="0" cellpadding="0" cellspacing="0" class="row" >
										<tbody>
											...
											<tr>
												<td align="center" class="heroTitle centerText" style="font-family: Roboto, sans-serif; font-size: 30px; line-height: 30px; font-style: italic; font-weight: 600; letter-spacing: 0px; padding: 0px 0px 20px;" valign="center"><strong><span style="font-weight: normal;">Скоро закончится демо-версия PHPShop</span></strong></td>
											</tr>
											<tr>
											    <td align="center" class="heroDescription centerText" style="font-family:Roboto,sans-serif;color:#000000;font-size:14px;line-height:22px;font-weight:400;letter-spacing:0px;padding:20px;padding-bottom:40px;" valign="middle">
                                ...
                                <p>
                                    ...
                                    Для перехода на полную версию необходимо приобрести лицензию. 
                                    <b>Все изменения, произведенные на демо-версии сайта, сохранятся</b>.
                                </p>
                                <p>
                                    В случае, если Вы не нашли нужный функционал, или у Вас есть вопросы по работе с платформой, пожалуйста, задайте нам вопросы в чате.</b>. 
                                </p>
                                <p>
                                    Все наши пользователи получают <b>полгода бесплатной техподдержки</b>: 
                                    доступ к обновлениям, консультации наших специалистов по 
									...
									<table align="left" border="0" cellpadding="0" cellspacing="0" class="row">
										<tbody>
											...
											<tr>
												...
												Служба техподдержки PHPShop<br />
												+7 (495) 989-11-15<br />
									...
									<table align="left" border="0" cellpadding="0" cellspacing="0" class="row">
										<tbody>
											<tr>
												...
												Copyright &copy; PHPShop&trade; 2004-2020г. Все права защищены.<br />
												&nbsp;</td>
											</tr>
										</tbody>
									</table>
