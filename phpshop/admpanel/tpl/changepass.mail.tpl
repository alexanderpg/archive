        ...
        <meta http-equiv="Content-Type" content="text/html; charset=@charset@">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
                <style type="text/css">
                    ...
                    ul, li, tr, td, h2 {margin-left:15px; padding-right:15px; padding-top:3px;}
                    img {border:none;}
                        ...
                        <tbody>    
                            <tr bgcolor="#fafafa" id="header" valign="top">
                                <td id="logo" align="left" valign="bottom">
                                    <div align="center" style="padding-top:30px;"><a href="http://@serverPath@" target="_blank"><img src="http://@serverPath@@logo@" alt="logo @serverPath@" border="0" style="display: block;" alt=""></a>
