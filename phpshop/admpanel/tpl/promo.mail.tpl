					...
					<tr>
						...
						<table align="center" border="0" cellpadding="0" cellspacing="0" class="row" style="width:100%;max-width:100%;" width="100%">
							<tbody>
                                ...
                                <p>
                                    В случае, если Вы не нашли нужный функционал, рекомендуем <a href="https://help.phpshop.ru/new/">уточнить</a>  этот вопрос  у техподдержки.
                                    - <b>мы с удовольствием подскажем, где искать нужную Вам опцию</b>. 
                                </p>
                                <p>
                                    Напоминаем, что все пользователи PHPShop получают <b>полгода бесплатной техподдержки</b>, 
