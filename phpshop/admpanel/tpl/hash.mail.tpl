                        ...
                        <tbody>
                            ...
                            <tr>
                                <td bgcolor="#f3f3f3" align="center" height="60"
                                   ...
                                   {Обновление пароля пользователя} @login@
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td
                                    style="color: #646464;font-family: Helvetica, sans-serif; font-size: 15px;line-height: 24px; ">
                                       ...
                                       <p style="margin-top: 20px;">{Вы запросили обновление пароля  к панели администрирования на сайте} @serverPath@.</p>

                                        
                                        <p>{Для восстановления пароля перейдите по} <a href="http://@serverPath@/phpshop/admpanel/?newPassGen=@hash@" target="_blank">{ссылке}</a>. </p>
                                        <br><br>
