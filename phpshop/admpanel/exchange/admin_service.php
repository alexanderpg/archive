...
// Разрешенные таблицы
$check_array = array('phpshop_1c_jurnal', 'phpshop_search_jurnal', 'phpshop_rssgraber_jurnal', 'phpshop_modules_guard_log', 'phpshop_modules_guard_crc', 'phpshop_modules_stat_visitors', 'phpshop_modules_productlastview_memory', 'phpshop_modules_admlog_log', 'phpshop_modules_errorlog_log', 'phpshop_modules_visualcart_memory', 'phpshop_modules_cron_log', 'phpshop_modules_visualcart_log','phpshop_modules_ozonseller_log');
...
WHERE table_schema = "' . $GLOBALS['SysValue']['connect']['dbase'] . '" order by table_rows desc';
    ...
    $help = '<p class="text-muted">'.__('Сервисные таблицы относятся к модулям и журналам. Для увеличения скорости сайта нужно периодически очищать и оптимизировать БД. Для очистки сервисной таблицы в списке следует нажать ссылку <kbd>Очистить</kbd></p> <p class="text-muted">Для увеличения производительности сайта вызвать SQL команду <kbd>Оптимизировать БД</kbd>').'</p>';
