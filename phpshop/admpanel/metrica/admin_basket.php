...
$TitlePage = __("Статистика - Товары в корзине");
...
function actionStart() {
    ...
    $PHPShopInterface->action_button['Показать в Метрике'] = array(
        ...
        'action' => 'https://metrika.yandex.ru/stat/basket?id=' . $metrica_id,
    ...
    $array_url_data = array(
        'preset' => 'basket',
        'metrics' => 'ym:s:productBasketsQuantity, ym:s:productBasketsUniq, ym:s:productBasketsPrice, ym:s:productPurchasedQuantity',
        'group' => $_GET['group'],
        'date1' => $date_start,
        'date2' => $date_end,
        'id' => $metrica_id,
    ...
    $PHPShopInterface->setCaption(array("Название товара", "50%"), array("Визиты", "10%"), array("В корзине", "10%"), array("Стоимость", "10%"), array("Куплено", "10%", array('align' => 'center')));
