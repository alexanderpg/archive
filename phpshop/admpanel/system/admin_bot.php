...
function actionStart() {
    ...
    $PHPShopInterface->setCaption(array(null, "3%"), array("Название", "50%"), array("Дата добавления", "15%"), array("Дата блокировки", "15%"), array("", "10%"), array("Доступ на сайт", "15%", array('align' => 'right')));
